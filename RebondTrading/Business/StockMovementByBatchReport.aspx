<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="StockMovementByBatchReport.aspx.vb" Inherits="RebondTrading.StockMovementByBatchReport" %>
...
<h2>Item Movement By Batch Report</h2>
        ...
        <div class="twocolleft50" > 
            <div class="Table"  >                
                ...
                <div class="Row">
                    <div class="Cell"><asp:Label ID="lblForSkuFrom"  runat="server" Text="Item From"></asp:Label></div>
               ...
               <%-- <div class="Row">
                    <div class="Cell"><asp:Label ID="lblForReferenceFrom"  runat="server" Text="PO No/Reference "></asp:Label></div>
                    <div class="Cell"> <asp:TextBox ID="ReferenceFrom" runat="server"  ></asp:TextBox>                         
                        </div>
                </div>   --%>                 
            </div>
        </div>
