<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LocMaster.aspx.vb" Inherits="RebondTrading.LocMaster" %>
...
<div class="MainContent">
    <div class="FormHeader">
        ...
        <asp:Panel ID="Panel1" runat="server" DefaultButton="btnAddOrUpdate">         
            <div class="Table">                               
                <div class="Row">
                    <div class="Cell"><asp:Label ID="labelForLocation" runat="server" AssociatedControlID="Location" Text="Location Code" ></asp:Label></div>
                    <div class="Cell"><asp:TextBox ID="Location" runat="server" MaxLength="20" CssClass="textEntry"  ></asp:TextBox>
                    <asp:RequiredFieldValidator ID="LocationRequired" ControlToValidate="Location" ValidationGroup="HeaderValidation" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                    </div>
                </div>                         
                <div class="Row">
        ...
        <asp:Panel ID="Panel2" runat="server" DefaultButton="btnSearch">         
            <div class="Table">
                ...
                <div class="Row">
                    <div class="Cell"><asp:Label ID="labelForSearchLocation" runat="server" AssociatedControlID="SearchLocation" Text="Search Location Code" ></asp:Label></div>
                    <div class="Cell"><asp:TextBox ID="SearchLocation" runat="server" MaxLength="20" CssClass="textEntry300" ></asp:TextBox>                       
                    </div>
                </div>                         
                <div class="Row">
                    <div class="Cell">&nbsp;</div>
    ...
    <div class="GridViewSalesPersons">
        <center>
            <asp:GridView ID="LocationMasterListGrid"
             AllowSorting="False"
             AllowPaging="True" 
             runat="server"
             CellPadding="4"
             ...
             >
                ...
                <Columns>
                    <asp:BoundField DataField="Location" HeaderText="Location Code" />                                                                                     
