            ...
            Else
                ...
                If Not IsNothing(DeliveryPlannerLinesDataTable) Then
                    If DeliveryPlannerLinesDataTable.Rows.Count <= 0 Then
                        AppSpecificFunc.GridNoDataFound(GoodsReceiptMasterGrid)
                    End If
                End If
            End If
...
#Region "Form Related functions"
    ...
    Private Function LoadItemsFromDataBase() As DataTable
        Try
            ...
            InputQuery1 = " Select T1.*  from GoodsReceiptItems T1 "
            ...
            If FilterDate.Text.ToString <> String.Empty Then
                Conditionlist1.Add(" ( T1.ReceiptDate>=@FromFilterDate AND T1.ReceiptDate<=@ToFilterDate ) ")
            ...
            If Not IsNothing(ResultDataTable) Then
                ...
                AppSpecificFunc.BindGridData(ResultDataTable, GoodsReceiptMasterGrid)
            End If
