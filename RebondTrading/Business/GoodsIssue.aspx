<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="GoodsIssue.aspx.vb" Inherits="RebondTrading.GoodsIssue" %>
...
<div class="MainContent">
    <div class="FormHeader"> 
     ...
     <div class="FormHeader">
        ...
        <center>
         <asp:GridView ID="GoodsIssueMasterGrid"
             AllowSorting="True"
             AllowPaging="True" 
             runat="server"
             CellPadding="4"
             ...
             >
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button ID="btnView" runat="server" CommandArgument='<%# Eval("IdKey")%>' CommandName="Preview" Text="Preview" />
                        </ItemTemplate>
                    </asp:TemplateField>                
                </Columns>
                </asp:GridView>
                <% If GoodsIssueMasterGrid.Rows(0).Cells.Count > 1 Then%>
                <i>You are viewing page
                <%=GoodsIssueMasterGrid.PageIndex + 1%>
                of
                <%=GoodsIssueMasterGrid.PageCount%>
                </i>
                <% End If%>
                </center>
</div>
