...
Public Class StockMovementByBatchReport
...
#Region "Form Event Handlers"
    ...
    Private Sub StockMoveRptforCarton_Init(sender As Object, e As EventArgs) Handles Me.Init
        Try
            ...
            Dim ReportFileName As String = Server.MapPath("~\RptFiles\stockMovementBatch.rpt")
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        Try
            If Page.IsValid Then
                ...
                'If ReferenceFrom.Text <> String.Empty Then
                '    crReportDocument.ReportDocument.SetParameterValue("@reference", ReferenceFrom.Text.Trim)
                'Else
                '    crReportDocument.ReportDocument.SetParameterValue("@reference", Nothing)
                '    Session("reference") = ReferenceFrom.Text.Trim
                'End If
    ...
    Private Sub btnClear_Click(sender As Object, e As EventArgs) Handles btnClear.Click
        Try
            ...
            'ReferenceFrom.Text = String.Empty
