...
#Region "Form Event Handlers"
    ...
    Private Sub StockMoveRptforCarton_Init(sender As Object, e As EventArgs) Handles Me.Init
        Try
            ...
            Dim ReportFileName As String = Server.MapPath("~\RptFiles\ItemBalance.rpt")
            ...
            If Not IsNothing(Session("From_Whs")) Then
                crReportDocument.ReportDocument.SetParameterValue("@From_Whs", Session("From_Whs").ToString)
            Else
                crReportDocument.ReportDocument.SetParameterValue("@From_Whs", Nothing)
            End If

            If Not IsNothing(Session("To_Whs")) Then
                crReportDocument.ReportDocument.SetParameterValue("@To_Whs", Session("To_Whs").ToString)
            Else
                crReportDocument.ReportDocument.SetParameterValue("@To_Whs", Nothing)
            End If
            ...
            crReportDocument.ReportDocument.SetParameterValue("@Reference", Nothing)
        ...
        Try
            If Page.IsValid Then
                ...
                If LocationFrom.Text <> String.Empty Then
                    crReportDocument.ReportDocument.SetParameterValue("@From_Whs", LocationFrom.Text.Trim)
                Else
                    crReportDocument.ReportDocument.SetParameterValue("@From_Whs", Nothing)
                    Session("From_Whs") = LocationFrom.Text.Trim
                End If

                If LocationTo.Text <> String.Empty Then
                    crReportDocument.ReportDocument.SetParameterValue("@To_Whs", LocationTo.Text.Trim)
                Else
                    crReportDocument.ReportDocument.SetParameterValue("@To_Whs", Nothing)
                    Session("To_Whs") = LocationTo.Text.Trim
                End If
