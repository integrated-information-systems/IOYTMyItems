<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ManageUsers.aspx.vb" Inherits="RebondTrading.ManageUsers" %>
          ...
          <div >
                      ...
                      CssClass="textEntry" ></asp:TextBox><asp:CompareValidator ID="PasswordCompare" runat="server" ControlToCompare="Password"
                        ...
                        ValidationGroup="RegisterUserValidationGroup">*</asp:CompareValidator>
                         ...
                         <p>
                          <asp:Label ID="lblForAbbreviation" runat="server" AssociatedControlID="Abbreviation">Abbreviation:</asp:Label>
                          <asp:TextBox runat="server" ID="Abbreviation" MaxLength="10"></asp:TextBox>                              
                         </p>
                         </fieldset>
